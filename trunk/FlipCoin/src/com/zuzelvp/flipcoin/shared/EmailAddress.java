...
* 
* Note: The class EmailAddress was simplified in order to be used in FlipCoin
*/
...
public class EmailAddress {
	...
	*/
	...
	public static final RegExp VALID_PATTERN = RegExp.compile(patternString);
	...
	*/
	public static boolean isValidTex(String email) {
	    return (email != null) && VALID_PATTERN.test(email);
	}
